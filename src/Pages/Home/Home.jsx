...
const Home = () => {
  ...
  return (
    <div id='home_page' className='py-10 relative'>
      ...
      <div className={`absolute ${inboxExpanded ? 'bottom-[0px]' : 'bottom-[-165px]'} right-0 w-7/12 md:w-6/12 lg:w-4/12 xl:w-3/12 2xl:w-2/12 hidden sm:block min-h-[80%] bg-white border border-gray-300 rounded-lg shadow-md`}>
